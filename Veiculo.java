...
public class Veiculo extends JFrame implements ActionListener {
    ...
    public Veiculo() {
        ...
        combo = new JComboBox<>(new String[]{"CHEVROLET", "HONDA", "FERRARI", "RENAULT", "FIAT", "Outras Opções"});
    ...
    public void actionPerformed(ActionEvent evento) {
        if (evento.getSource() == btCadastrar) {
            cadastrar();
        } else if (evento.getSource() == btAlterar) {
            alterar();
        } else if (evento.getSource() == btExcluir) {
            excluir();
    ...
    private void alterar() {
        // Implemente a lógica para alterar um veículo
    }

    private void excluir() {
        // Implemente a lógica para excluir um veículo
    }
